package mg.pendragon.pojaBigSum.unit;
...
import mg.pendragon.pojaBigSum.endpoint.event.EventConsumer;
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent(
            "mg.pendragon.pojaBigSum.endpoint.event.gen.UuidCreated", payload);
